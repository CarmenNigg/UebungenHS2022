...
function App() {
  ...
  function transform() {
    const url = `https://geodesy.geo.admin.ch/reframe/lv95towgs84?easting=${eastern}&northing=${northern}`;
    setLoading(true);
    axios
      .get(url)
  ...
  return (
    <>
      <h1>Koordinatentransformation LV95 nach WGS84</h1>
      <Grid container spacing={2}>
        ...
        <Grid item xs={4}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField fullWidth disabled label='Logn' variant='outlined' helperText=" " InputLabelProps={{
                shrink: true,
