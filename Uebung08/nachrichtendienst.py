...
DB = {
    "lucky": {"name": "Lukas", "email": "lukas@fhnw.ch", "password": "moin"},
    "Stefanius": {"name": "Stefan", "email": "stefan.j@fhnw.ch", "password": "agrar"},
    "Odin": {"name": "Riccardo", "email": "ricci.l@fhnw.ch", "password": "Käppeli"}}
